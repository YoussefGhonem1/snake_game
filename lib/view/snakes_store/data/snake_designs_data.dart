...
class SnakeDesignsData {
  static final List<SnakeDesign> snakeDesigns = [
    ...
    SnakeDesign(
      ...
      requiredLevel: 2,
      imgPaths: [
        'assets/images/snakeShapes/fire_snake/Head.png',
        ...
        'assets/images/snakeShapes/fire_snake/snake_body256_vertical00.png',
        'assets/images/snakeShapes/fire_snake/snake_body256_vertical01.png',
        'assets/images/snakeShapes/fire_snake/bottom-right.png',
        'assets/images/snakeShapes/fire_snake/bottom-left.png',
        'assets/images/snakeShapes/fire_snake/top-right.png',
        'assets/images/snakeShapes/fire_snake/top-left.png',
        'assets/images/snakeShapes/fire_snake/RedFireSnake.jpg',
      ],
    ),
    SnakeDesign(
      //2
